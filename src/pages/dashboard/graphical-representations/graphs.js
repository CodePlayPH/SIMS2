...
export function BarGraphs() {
  ...
  const { salesData, salesLabel, salesLoading } = useContext(DashboardContext)
  const prodLookup = {};
  ...
  return (
    <>
      {salesLoading ? <div style={{
        display: "flex",
        height:'100%',
        justifyContent: "center",
        alignItems: "center",
      }}> <CircularProgress /></div> : <MDBContainer className="mainBar-container">
          <h3 className="mt-5">Monthly Sales</h3>
